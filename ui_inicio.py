...
def mostrar_inicio():
    ...
    /* Responsive MÓVIL - FULL WIDTH FORZADO */
    @media (max-width: 768px){
        /* Container principal sin padding lateral */
