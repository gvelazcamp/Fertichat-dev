...
def mostrar_inicio():
    ...
    <style>
    /* =========================================================
       PC (DESKTOP) - TARJETAS LINDAS CON BOTONES STREAMLIT
       ========================================================= */
    
    /* MOSTRAR en desktop, OCULTAR en móvil */
    ...
    /* Columnas relativas para íconos absolutos */
    ...
    /* =========================================================
       MÓVIL (CELULAR) - TARJETAS HTML CLICKEABLES
       ========================================================= */
    ...
    # =========================
    # LAYOUT DESKTOP (PC - BOTONES STREAMLIT)
    # =========================
    ...
    # =========================
    # LAYOUT MÓVIL (CELULAR - TARJETAS HTML)
    # =========================
