...
# LAS TARJETAS HERMOSAS ORIGINALES - NAVEGACIÓN ARREGLADA
# =========================
...
def mostrar_inicio():
    ...
    # =========================
    # Inicializar estado de navegación pendiente
    if "pending_nav" not in st.session_state:
        st.session_state["pending_nav"] = None

    # Detectar navegación pendiente de query params
    try:
        ...
        if go:
            ...
            if destino:
                st.session_state["pending_nav"] = destino
                st.query_params.clear()
    except:
        pass

    # Ejecutar navegación pendiente ANTES de renderizar
    if st.session_state["pending_nav"]:
        destino = st.session_state["pending_nav"]
        st.session_state["pending_nav"] = None
