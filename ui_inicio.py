...
def mostrar_inicio():
    ...
    # =========================
    # CSS para HOME (PC + MÓVIL) - SIN CAMBIOS
    # =========================
    st.markdown("""
    <style>
    /* =========================================================
    ...
    # =========================
    # JavaScript para navegación (NUEVO - sin tocar HTML)
    # =========================
    st.markdown("""
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.fc-mcard').forEach(function(card) {
            card.addEventListener('click', function() {
                const goValue = this.getAttribute('data-go');
                if (goValue) {
                    window.location.href = '? go=' + goValue;
                }
            });
        });
    });
    ...
    # =========================
    # Helpers HTML (móvil) - SOLO cambio:  data-go en vez de onclick
    # =========================
    ...
    # =========================
    # LAYOUT MÓVIL (ÚNICO - FORMATO PERFECTO)
    # =========================
