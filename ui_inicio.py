...
def mostrar_inicio():
    ...
    # =========================
    # CSS para HOME (SOLO MÓVIL POR AHORA)
    # =========================
    st.markdown("""
    <style>
    /* =========================================================
    ...
    /* Ocultar layout desktop (comentado) */
    . fc-home-desktop { display:  none; }
    
    /* Mostrar layout móvil */
    . fc-home-mobile { display:  block; }
    ...
    # =========================
    # Helpers HTML (móvil) - CON ONCLICK PARA MISMA PESTAÑA
    # =========================
