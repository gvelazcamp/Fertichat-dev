...
def mostrar_inicio_desktop():
    ...
    div[data-testid="stAppViewContainer"]:has(#fc-home-desktop-marker) .fc-home-tile{
        ...
        position:absolute;
        left: 16px;
        top: calc(50% + 70px);          /* <-- AJUSTADO PARA BASE 140px */
    ...
    .card-inteligencia ~ .fc-home-tile { top: calc(50% + 80px); }
    .card-operaciones ~ .fc-home-tile { top: calc(50% + 60px); }
    .card-control ~ .fc-home-tile { top: calc(50% + 60px); }
    ...
    @media (max-width: 900px){
        ...
        /* Ajustes mobile */
        .card-inteligencia { height: 120px; min-height: 120px; }
        ...
        .card-inteligencia ~ .fc-home-tile { top: calc(50% + 60px); }
